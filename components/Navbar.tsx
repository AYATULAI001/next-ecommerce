...
import logoutAction from '@/action/Auth/auth/logout';
          ...
          <div className='hidden md:flex items-center space-x-4 '>
            ...
            {!user && isLoading === false && (
              <div className='flex space-x-2'>
                <div>
                  <Link href='/Auth/auth?type=login'>
                    <Button
                      variant='outline'
                ...
                <div>
                  <Link href='/Auth/auth?type=signup'>
