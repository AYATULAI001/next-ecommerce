          ...
          <div>
            ...
            <div>
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8">
                {isSignUp
                  ? "Join Sahandstore today and discover our exclusive deals on your favourite products."
                  : "Welcome back to Sahandstore! Login to continue your shopping journey."}
              </p>
            </div>
    {isLoading ? (
            ...
            <div className="mt-4 sm:mt-5 flex items-center justify-center">
              ...
              <button
                className="ml-2 text-lg sm:text-xl lg:text-2xl text-gray-500 cursor-pointer"
                onClick={toggleForm}
              >
